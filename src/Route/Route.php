...
namespace adevws\Routing\Route;

use adevws\Routing\Http\Request;
use adevws\Routing\Exceptions\ClassNotFoundHttpException;
...
abstract class Route implements IRoute
{
     ...
     */
    public function renderRoute(Request $request, Manager $router): ?string
    {
