...
use adevws\Routing\Http\Exceptions\MalformedUrlException;
use adevws\Routing\Http\Middleware\BaseCsrfVerifier;
use adevws\Routing\Http\Request;
use adevws\Routing\Http\Url;
use adevws\Routing\ClassLoader\ClassLoader;
use adevws\Routing\ClassLoader\IClassLoader;
use adevws\Routing\Exceptions\HttpException;
use adevws\Routing\Exceptions\NotFoundHttpException;
use adevws\Routing\Handlers\EventHandler;
use adevws\Routing\Handlers\IEventHandler;
use adevws\Routing\Handlers\IExceptionHandler;
use adevws\Routing\Route\IControllerRoute;
...
class Manager
{
     ...
     * @return $this
     */
    protected function setRenderMultipleRoutes(bool $bool): self
    {
